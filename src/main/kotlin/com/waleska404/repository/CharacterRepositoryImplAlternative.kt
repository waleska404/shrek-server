...
class CharacterRepositoryImplAlternative : CharacterRepositoryAlternative {

    override val characters = listOf(
        Character(
            id = 1,
            name = "Sasuke",
    ...
    override suspend fun getAllCharacters(page: Int, limit: Int): ApiResponse {
        return ApiResponse(
            success = true,
            message = "ok",
